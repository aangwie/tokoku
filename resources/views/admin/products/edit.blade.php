            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <div class="max-w-xl">
                    <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div id="shippingCostField" class="mb-4" style="display: {{ old('is_free_shipping', $product->is_free_shipping ? '1' : '0') == '0' ? 'block' : 'none' }};">
                            <label for="shipping_cost" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Biaya Ongkir (Rp)</label>
                            <input type="number" name="shipping_cost" id="shipping_cost" min="0" step="0.01" value="{{ old('shipping_cost', $product->shipping_cost) }}" 
