                        ...
                        <div class="mb-4">
                            ...
                            <div class="space-y-2">
                                <label class="inline-flex items-center">
                                    <input type="radio" name="is_free_shipping" value="1" {{ old('is_free_shipping', $product->is_free_shipping ? '1' : '0') == '1' ? 'checked' : '' }} 
                                ...
                                <label class="inline-flex items-center ml-6">
                                    <input type="radio" name="is_free_shipping" value="0" {{ old('is_free_shipping', $product->is_free_shipping ? '1' : '0') == '0' ? 'checked' : '' }}
                                           class="rounded-full border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
